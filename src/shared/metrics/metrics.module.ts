...
export class MetricsController {
  ...
  @ApiOperation({
    ...
    description:
      "Returns all metrics in Prometheus text format. Scrape with your Prometheus instance. Requires Authorization: Bearer <INTERNAL_API_KEY>.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 401,
    description: "Missing or invalid INTERNAL_API_KEY",
  })
