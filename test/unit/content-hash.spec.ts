...
describe("computeContentHash", () => {
  ...
  it("uses a 1-minute bucket for captured_at_utc", () => {
    ...
    const h2 = computeContentHash({
      ...baseInput,
      captured_at_utc: "2024-03-15T10:30:59Z",
    });
    expect(h1).toBe(h2);
  });
  ...
  it("produces different hashes for different minutes", () => {
    ...
    const h2 = computeContentHash({
      ...baseInput,
      captured_at_utc: "2024-03-15T10:31:00Z",
    });
  ...
  it("known fixed-point hash is stable across Node versions", () => {
    // Pre-computed independently: echo -n "fixed-user|7I|2024-01-01T12:00|57.9|17.8|142|-1" | sha256sum
    // Update ONLY if the hash algorithm changes intentionally.
    const expected =
      "e98cdd23cb557b62807efe7efba54fc00e0ca2ce2ce9df9cb902c171b6e41aaf";
    expect(
      computeContentHash({
